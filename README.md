...
|seq.|    날짜        |     내용                                                                                      | 후기
|----| ---------|----------------------------------------------|-----
|  1 |2016. 7.26|(R 기초) R컴퓨팅 :  R설치 및 실습환경 구축,  [제3장  데이터 입력과 출력](https://github.com/biospin/R_Bio/blob/master/part01/week1_160726/01_basic/3%EC%9E%A5%20%EB%8D%B0%EC%9D%B4%ED%84%B0%20%EC%9E%85%EB%A0%A5%EA%B3%BC%20%EC%B6%9C%EB%A0%A5.ipynb)  (지용기)
|    |          |(R 중급 )  ISL : 2장 Statistical Learning (김가경)
|    |          |(R 바이오) R for Bioinformatics : DNA Sequence Statistics (1) (이승우)
|    |          |(R 고급)   (구글 genomics) https://cloud.google.com/genomics/install-genomics-tools :  How-to Guide : Installing the Cloud SDK and Genomics Commands  (이병철)
...
|    |          |(R 고급)    (DataAlgorithm) 3장. Top 10 List을 Spark-R로 구현
...
|seq.|    날짜        |내용                                                                                                  | 후기
|----| ---------|----------------------------------------------|-----
|  1 |2016. 9.20|(R 기초) 데이터시각화 : 2 장 탐색적 자료분석
|    |          |(R 중급 )  ISL : 10 Unsupervised Learning
...
|  2 |2016. 9.27|(R 기초) 데이터시각화 : 3 장 이변량 데이터의 시각화
...
|  3 |2016.10. 4|(R 기초) 데이터시각화 : 4 장 시계열의 시각화
...
|  4 |2016.10.11|(R 기초) 데이터시각화 : 5 장 지리적 데이터의 시각화
...
|seq.|    날짜        |내용                                                                                                  | 후기
|----| ---------|----------------------------------------------|-----
|  1 |2016.10.18|(R 기초) 데이터시각화 : 6 장 텍스트 데이터의 시각화 - 워드 클라우드
...
|  2 |2016.10.25|(R 기초) 데이터시각화 : 7 장 다변량 데이터의 시각화
...
|  3 |2016.11. 1|(R 기초) 데이터시각화 : 8 장 웹을 이용한 동적 · 대화형 데이터 시각화
...
|  4 |2016.11. 8|(R 중급 )  R 고급활용 : 제7장 분류분석
